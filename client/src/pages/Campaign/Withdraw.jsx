...
// import { contractABI } from '../../Config/config'; // Adjust the path as necessary
                ...
                const enrichedCampaigns = await Promise.all(
                    data.map(async (campaign) => {
                        try {
                            ...
                            const targetAmountWei = targetAmount.toString();
                            const amountRaisedEther = ethers.formatEther(amountRaised);

                            const progressPercentage = targetAmountWei > 0
                                ? (amountRaisedEther / targetAmountWei) * 100
                                : 0;
